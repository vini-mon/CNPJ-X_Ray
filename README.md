...
- <u>Secundário(s)</u>: Significa as atividade secundárias a empresa exerce e que geram uma receita menor.Permite que a empresa opere legalmente em frentes diferentes.
...
- Novos Agentes: Adicionar o Agente de Due Diligence (Jurídico) e o Agente de Reputação (Mídia) para uma análise mais ampla entre outros agentes que podem ser úteis.
